...
avatar = media.Movie("Avatar", "Blue smurfs try not to get blown up",
...
the_prince_of_egypt = media.Movie("The prince of Egypt",
                                  "Best Movie OF ALL TIME. Das all u need ta know", "http://www.gstatic.com/tv/thumb/movieposters/22187/p22187_p_v8_aa.jpg",
...
thor_ragnarok = media.Movie("Thor Ragnarok", "Thor swings his mighty hammer",
...
justice_league = media.Movie("Justice league", "Off brand avengers",
...
movies = [avatar ,toy_story, star_wars_the_force_awakens, thor_ragnarok, justice_league, the_prince_of_egypt]
